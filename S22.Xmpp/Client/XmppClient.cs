...
namespace S22.Xmpp.Client {
	...
	public class XmppClient : IDisposable {
        ...
        /// <summary>
        /// Executes the an Ad-Hoc command.
        /// </summary>
        /// <returns>A session to perform a mult-staged command.</returns>
        /// <param name="node">This matches the 'node' attribute from the service discovery.
        /// Service Discovery requires that all 'node' values be unique within a given JID.</param>
        public AdHocCommandSession ExecuteAdHocCommand(string node)
        {
